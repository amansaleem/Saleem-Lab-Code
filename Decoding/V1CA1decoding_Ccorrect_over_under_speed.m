...
for iseries = 1:7
    ...
    X_all.na = [];                      V_all.na = [];
    spd = 50*normalise1var(CA(iseries).data.smthBallSpd);
    spd_l = spd(CA(iseries).t_low);
    spd_n = spd(CA(iseries).t_norm);
    spd_h = spd(CA(iseries).t_high);
