...
for idx = [8 4 6 7 5 1:3] %1:length(expt_list)
   [out] = plot_some_decoding_byTheta_new5(expt_list(idx).animal, ...
...
save ./Data/Posterior_all_161031_trainedCV_thetaBins_FineBin_EVover50_win16 -v7.3