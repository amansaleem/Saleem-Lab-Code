...
for idx = [4 7 5 1:3 6 8] %1:length(expt_list)
   [out] = plot_some_decoding_byTheta_new4(expt_list(idx).animal, ...
...
save Posterior_all_161028_trainedCV_thetaBins_FineBin_EVover50 -v7.3