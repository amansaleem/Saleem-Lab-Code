...
for idx = [8 4 7 5 1:3 6] %1:length(expt_list)
   [out] = plot_some_decoding_byTheta_new3(expt_list(idx).animal, ...
...
% save Posterior_all_160525b_trainedCV_thetaBins_FineBin_EVover50 -v7.3
save Posterior_all_161029b_trainedCV_thetaBins_FineBin_EVover50 -v7.3