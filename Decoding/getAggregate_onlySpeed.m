...
errorarea_as((1:size(corr_time_diff_high_low,2)-1)*time_bin,...
    nanmean(toplot(:,2:end)), nansem(toplot(:,2:end)),'r');
% title('High contrast','fontsize',14)
% errorarea_as((1:size(corr_time_high,2)-1)*time_bin, nanmean(corr_time_diff_wrong(:,2:end)), nansem(corr_time_diff_wrong(:,2:end)),'m');
axis square;
axis tight
...
subplot(221)
errorarea_as((1:size(corr_time_high,2)-1)*time_bin,...
    nanmean(corr_time_high(:,2:end)), nansem(corr_time_high(:,2:end)),'r');
hold on;
errorarea_as((1:size(corr_time_low,2))*time_bin,...
    nanmean(corr_time_low(:,2:end)), nansem(corr_time_low(:,2:end)),'b');
errorarea_as((1:size(corr_time_norm,2))*time_bin,...
    nanmean(corr_time_norm(:,2:end)), nansem(corr_time_norm(:,2:end)),'k');
% errorarea_as((1:size(corr_time_gray,2))*time_bin, nanmean(corr_time_gray(:,2:end)), nansem(corr_time_gray(:,2:end)),'c');
axis square;
axis tight
set(gca, 'box','off','TickDir','out','fontsize',14,'color','none');
% line(xlim, [0 0], 'linestyle','--', 'color','k');
...
subplot(223)
errorarea_as((1:size(corr_time_diff_high_low,2)-1)*time_bin,...
    mean(corr_time_diff_high_low(:,2:end)), sem(corr_time_diff_high_low(:,2:end)),'r');
axis square;
set(gca, 'box','off','TickDir','out','fontsize',14,'color','none');
line(xlim, [0 0], 'linestyle','--', 'color','k');
xlabel('Delay (bins)')
...
subplot(222)
errorarea_as((1:size(corr_time_diff_high,2)-1)*time_bin, nanmean(corr_time_diff_high(:,2:end)), nansem(corr_time_diff_high(:,2:end)),'r');
hold on;
errorarea_as((1:size(corr_time_diff_low,2)-1)*time_bin, nanmean(corr_time_diff_low(:,2:end)), nansem(corr_time_diff_low(:,2:end)),'b');
% errorarea_as((1:size(corr_time_diff_low,2)-1)*time_bin, nanmean(corr_time_diff_gray(:,2:end)), nansem(corr_time_diff_gray(:,2:end)),'c');
axis square;
set(gca, 'box','off','TickDir','out','fontsize',14,'color','none');
line(xlim, [0 0], 'linestyle','--', 'color','k');
xlabel('Delay (bins)')
...
errorarea_as((1:size(corr_time_diff_high_low,2)-1)*time_bin,...
    nanmean(toplot(:,2:end)), nansem(toplot(:,2:end)),'b');
...
errorarea_as((1:size(corr_time_diff_high_low,2)-1)*time_bin,...
    nanmean(toplot(:,2:end)), nansem(toplot(:,2:end)),'k');
...
errorarea_as((1:size(corr_time_diff_high_low,2)-1)*time_bin,...
    nanmean(toplot(:,2:end)), nansem(toplot(:,2:end)),'m');
