function getBallData(animal, iseries, iexp)
...
% load data
% AS: commented this out and added the lower two lines cause of problems
% loadging the Mouse files
...
AnimalDir = fullfile(DIRS.ball,animal);
